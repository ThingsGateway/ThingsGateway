...
{
    private static readonly GlobalDeviceData _globalDeviceData = App.GetService<GlobalDeviceData>();
    ...
    {
        var obj = _globalDeviceData.AllVariables.FirstOrDefault(it => it.Name == e.Name);
        if (obj == null)
        {
            return;
        }
