...
public class VariableData
{
    ...
    /// <inheritdoc cref="DeviceVariable.Description"/>
    ...
    /// <inheritdoc cref="DeviceVariableRunTime.LastErrorMessage"/>
    public string LastErrorMessage { get; set; }

    /// <inheritdoc cref="DeviceVariable.ReadExpressions"/>
    ...
    /// <inheritdoc cref="DeviceVariable.Address"/>
    public string Address { get; set; }

    /// <inheritdoc cref="DeviceVariable.ProtectTypeEnum"/>
    public int ProtectTypeEnum { get; set; }

    /// <inheritdoc cref="DeviceVariable.DataTypeEnum"/>
