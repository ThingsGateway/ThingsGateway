...
/// 上传数据库插件
/// </summary>
public abstract class UpLoadDatabaseWithCacheT<DeviceT, VariableT> : UpLoadBase
{
    /// <summary>
    /// <inheritdoc/><br></br>
    ...
    /// </summary>
    protected abstract UploadDatabasePropertyWithCacheT _uploadPropertyWithCache { get; }
