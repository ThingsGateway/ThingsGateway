...
public class TimerTick
{
    ...
    public TimerTick(int milliSeconds = 1000)
    {
        if (milliSeconds < 10)
            milliSeconds = 10;
        LastTime = SysDateTimeExtensions.CurrentDateTime.AddMilliseconds(-milliSeconds);
    ...
    /// </summary>
    /// <returns></returns>
    public bool IsTickHappen() => IsTickHappen(SysDateTimeExtensions.CurrentDateTime);
