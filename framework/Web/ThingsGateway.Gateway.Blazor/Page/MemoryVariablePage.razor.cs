...
public partial class MemoryVariablePage
{
    ...
    {
        await AjaxService.DownFileAsync("gatewayFile/memoryVariable", DateTimeExtensions.CurrentDateTime.ToFileDateTimeFormat(), input.Adapt<MemoryVariableInput>());
    }
    ...
    private async Task<ISqlSugarPagedList<DeviceVariable>> QueryCallAsync(MemoryVariablePageInput input)
    {
