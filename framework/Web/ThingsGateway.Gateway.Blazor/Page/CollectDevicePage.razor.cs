...
public partial class CollectDevicePage
{
    ...
    {
        await AjaxService.DownFileAsync("gatewayFile/collectDevice", DateTimeExtensions.CurrentDateTime.ToFileDateTimeFormat(), input.Adapt<CollectDeviceInput>());
    }
    ...
    {
        return BackgroundServiceUtil.GetBackgroundService<CollectDeviceWorker>().GetDevicePropertys(driverId, devId);
    }

    private async Task<ISqlSugarPagedList<CollectDevice>> QueryCallAsync(CollectDevicePageInput input)
    {
