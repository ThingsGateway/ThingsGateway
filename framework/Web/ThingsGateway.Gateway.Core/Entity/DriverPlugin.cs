...
public class DriverPlugin : BaseEntity
{
    ...
    /// 插件类名称
    /// </summary>
    [SugarColumn(ColumnDescription = "插件类名称")]
    ...
    /// 插件类型
    /// </summary>
    [SugarColumn(ColumnDataType = "varchar(50)", ColumnDescription = "插件类型", SqlParameterDbType = typeof(EnumToStringConvert))]
    ...
    /// 插件文件全路径
    /// </summary>
    [SugarColumn(ColumnDescription = "插件文件全路径")]
