...
{
    private static readonly SysMemoryCache SysMemoryCache = new();
    ...
    public static List<OpenApiPermissionTreeSelector> OpenApiPermissionTreeSelector()
    {
        ...
        List<OpenApiPermissionTreeSelector> displayName = SysMemoryCache.GetOrCreate(cacheKey, entry =>
        {
    ...
    public static List<PermissionTreeSelector> PermissionTreeSelector(List<string> routers)
    {
        ...
        List<PermissionTreeSelector> displayName = SysMemoryCache.GetOrCreate(cacheKey, entry =>
        {
