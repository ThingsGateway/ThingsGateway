...
internal class WaitingClientEx<TClient> : DisposableObject, IWaitingClient<TClient> where TClient : IClient, IDefaultSender, ISender
{
    ...
    public WaitingClientEx(TClient client, WaitingOptions waitingOptions, Func<ResponsedData, bool> func)
    {
    ...
    public WaitingClientEx(TClient client, WaitingOptions waitingOptions)
    {
        this.Client = client ?? throw new ArgumentNullException(nameof(client));
        this.WaitingOptions = waitingOptions;
    }
