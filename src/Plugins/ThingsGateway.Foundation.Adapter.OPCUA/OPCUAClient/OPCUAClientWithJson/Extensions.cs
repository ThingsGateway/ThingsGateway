...
namespace ThingsGateway.Foundation.Adapter.OPCUA
{
    public static class BuiltInExtensionMethods
    {
        ...
        public static Func<Variant> GetDecodeDelegate(this BuiltInType builtIn, PlatformJsonDecoder decoder)
        {
            switch (builtIn)
            {
                ...
                case BuiltInType.Byte:
                    return () => new Variant(decoder.ReadByte("Value"));
                case BuiltInType.Int16:
        ...
        public static Func<Variant> GetDecodeMatrixDelegate(this BuiltInType builtIn, PlatformJsonDecoder decoder)
        {
            switch (builtIn)
            {
                ...
                case BuiltInType.Byte:
                    return () => new Variant(new Matrix(decoder.ReadByteArray("Value").ToArray(), builtIn, decoder.Dimensions));
                case BuiltInType.Int16:
    ...
    public static class SessionExtensionMethods
    {
        ...
        public static bool IsServerStatusGood(this ISession session)
        {
