...
;
        ...
        public int ReadEnumeration(string fieldName)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Error: Property named " + fieldName + " must have the properties EnumIndex, and EnumValues");
                }
            ...
            if (enumTuple.enumStrings != null && (enumIndex > enumTuple.enumStrings.Length || enumIndex < 0 || enumTuple.enumStrings[enumIndex] != enumValue))
                throw new Exception("Wrong corrispondence between EnumIndex and EnumValue");
        ...
        public new ExtensionObject ReadExtensionObject(string fieldName)
        {
            ...
            {
                throw new Exception("Found a Standard Structured DataType not IEncodable");
            }
