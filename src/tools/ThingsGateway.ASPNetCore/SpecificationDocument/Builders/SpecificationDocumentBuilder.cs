...
public static class SpecificationDocumentBuilder
{
    ...
    {
        // 载入配置
        _specificationDocumentSettings = App.Configuration.GetSection("SpecificationDocumentSettings").Get<SpecificationDocumentSettingsOptions>();
        _specificationDocumentSettings.PostConfigure(_specificationDocumentSettings, App.Configuration);
        // 初始化常量
    ...
    private static void CustomizeIndex(SwaggerUIOptions swaggerUIOptions)
    {
        ...
        var customIndex = $"{Reflect.GetAssemblyName(thisAssembly)}.SpecificationDocument.Assets.index.html";
