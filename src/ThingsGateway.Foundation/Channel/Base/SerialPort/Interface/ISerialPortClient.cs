...
//    /// 串口客户端接口。
//    /// </summary>
//    public interface ISerialPortClient : IReceiverClient, IClient, ISender, IDefaultSender, IPluginObject, IRequsetInfoSender, ISetupConfigObject, IOnlineClient, IAdapterObject, IConnectObject, ICloseObject
//    {
//        /// <summary>
//        /// 成功打开串口
//        /// </summary>
