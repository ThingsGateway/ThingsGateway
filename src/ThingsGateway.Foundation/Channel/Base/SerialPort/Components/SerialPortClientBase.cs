...
//            catch (Exception ex)
//            {
//                this.Logger.Log(LogLevel.Error, this, DefaultResource.Localizer["EventError", nameof(this.Connected)], ex);
//            }
//        }
...
//            catch (Exception ex)
//            {
//                this.Logger.Log(LogLevel.Error, this, DefaultResource.Localizer["EventError", nameof(this.OnConnecting)], ex);
//            }
//        }
...
//        /// </summary>
//        /// <param name="e"></param>
//        protected virtual async Task OnDisconnected(ClosedEventArgs e)
//        {
//            try
//            {
...
//            catch (Exception ex)
//            {
//                this.Logger.Log(LogLevel.Error, this, DefaultResource.Localizer["EventError", nameof(this.Disconnected)], ex);
//            }
//        }
...
//        /// </summary>
//        /// <param name="e"></param>
//        protected virtual async Task OnDisconnecting(ClosingEventArgs e)
//        {
//            try
//            {
...
//            catch (Exception ex)
//            {
//                this.Logger.Log(LogLevel.Error, this, DefaultResource.Localizer["EventError", nameof(this.Disconnecting)], ex);
//            }
//        }
...
//            return this.OnDisconnected((ClosedEventArgs)obj);
//        }

//        private Task PrivateOnDisconnecting(object obj)
//        {
//            return this.OnDisconnecting((ClosingEventArgs)obj);
//        }
...
//                if (this.m_online)
//                {
//                    this.PrivateOnDisconnecting(new ClosingEventArgs(msg)).GetFalseAwaitResult();
...
//                if (this.m_online)
//                {
//                    this.BreakOut(true, DefaultResource.Localizer["ProactivelyDisconnect", nameof(Dispose)]);
//                }
//            }
...
//                if (this.Config == null)
//                {
//                    throw new ArgumentNullException(nameof(this.Config), DefaultResource.Localizer["ConfigNotNull"]);
//                }
//                var serialPortOption = this.Config.GetValue(SerialPortConfigExtension.SerialPortOptionProperty) ?? throw new ArgumentNullException(DefaultResource.Localizer["ConfigNotNull"]);
...
//                    this.PrivateOnDisconnected(new ClosedEventArgs(manual, msg)).GetFalseAwaitResult();
//                }
//            }
//        }
...
//            catch (Exception ex)
//            {
//                this.Logger.Log(LogLevel.Error, this, DefaultResource.Localizer["ReceiveError"], ex);
//            }
//        }
...
//            if (this.DataHandlingAdapter == null)
//            {
//                throw new ArgumentNullException(nameof(this.DataHandlingAdapter));
//            }
