...
/// 数据处理适配器
/// </summary>
public abstract class SerialDataHandlingAdapter : DisposableObject
{
    private ISerialClientBase m_client;
    ...
    public virtual void OnLoaded(ISerialClientBase client)
    {
        if (m_client != null)
        {
    ...
    /// 适配器拥有者。
    /// </summary>
    public ISerialClientBase Client => m_client;
