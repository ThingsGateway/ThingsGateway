...
public class VariableRunTime : Variable, IVariable
{
    ...
    /// 上次值
    /// </summary>
    [AutoGenerateColumn(Visible = false, Filterable = true, Sortable = true, Order = 6)]
    ...
    /// 实时值
    /// </summary>
    [AutoGenerateColumn(Visible = true, Filterable = true, Sortable = true, Order = 6)]
    ...
    /// <inheritdoc/>
    public async ValueTask<IOperResult> SetValueToDeviceAsync(string value, string? executive = "BLAZOR", CancellationToken cancellationToken = default)
    {
