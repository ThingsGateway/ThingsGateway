...
public class CollectDeviceCore : DisposableObject
{
    ...
    /// 全局插件服务
    /// </summary>
    protected PluginSingletonService _pluginService;
 ...
 , TaskCreationOptions.LongRunning);
    ...
    /// <returns></returns>
    public async Task<OperResult<object>> InvokeMedAsync(DeviceVariableMedRead deviceVariableMedRead)
    {
