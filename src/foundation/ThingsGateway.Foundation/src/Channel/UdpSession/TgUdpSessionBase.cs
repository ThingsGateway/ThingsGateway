...
namespace ThingsGateway.Foundation
{
    ...
    public class TgUdpSessionBase : ServiceBase, IUdpSession, IPluginObject
    {
        ...
        private void HandleBuffer(EndPoint endPoint, ByteBlock byteBlock)
        {
            ...
            {
                this.Logger.Exception(this, FoundationConst.ReceiveError, ex);
            }
            finally
            {
                byteBlock.Dispose();
        ...
        private void ProcessReceive(Socket socket, SocketAsyncEventArgs e)
        {
            ...
            {
                this.Logger.Error(this, string.Format(FoundationConst.ProcessReceiveError, e.SocketError, e.SocketError));
                e.SafeDispose();
            }
        }
