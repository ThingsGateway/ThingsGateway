...
{
    private readonly OpcDaMasterProperty _driverPropertys = new();
    ...
    /// <inheritdoc/>
    public override Type DriverDebugUIType => typeof(ThingsGateway.Demo.OpcDaMaster);
    ...
    {
        return $"{_driverPropertys.OpcIP}-{_driverPropertys.OpcName}";
    }
