...
/// QuestDBProducer
/// </summary>
public partial class QuestDBProducer : BusinessBaseWithCacheInterval<QuestDBHistoryValue>, IDBHistoryValueService
{
    ...
    internal ISugarQueryable<QuestDBHistoryValue> Query(DBValuePageInput input)
    {
        var db = BusinessDatabaseUtil.GetDb(_driverPropertys.DbType, _driverPropertys.BigTextConnectStr);
