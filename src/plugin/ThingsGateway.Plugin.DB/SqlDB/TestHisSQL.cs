...
//public class TestHisSQL : IDynamicSQL
//{
...
//        List<HisModel1> demoDatas = new List<HisModel1>();
//        HisModel1 demoData = new HisModel1();
