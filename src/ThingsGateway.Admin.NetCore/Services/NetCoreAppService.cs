...
public class NetCoreAppService : IAppService
{
    public NetCoreAppService()
    {
    ...
    public ClaimsPrincipal? User
    {
        ...
        {
            user = value;
            ((BlazorAuthenticationStateProvider)NetCoreApp.RootServices.GetService<AuthenticationStateProvider>()).UserChanged();
        }
    }
