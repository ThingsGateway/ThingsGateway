...
{
    /// <inheritdoc/>
    public static IMasaBlazorBuilder? AddComponents(this IServiceCollection services)
    {
        ...
        { "PImageCaptcha", new Dictionary<string, object>() { { "Dense", true } } }
             ...
             options.ConfigureTheme(theme =>
             {
                 ...
                 theme.Themes.Dark.UserDefined.Add("maincolor", "#272727");
                 ...
                 theme.Themes.Light.UserDefined.Add("maincolor", "#f0f3fe");
             });
             options.Locale = new Locale("zh-CN", "en-US");
         });
        blazorBuilder.AddI18nForServer("wwwroot/i18n");
        services.AddScoped<BlazorAppService>();
        return blazorBuilder;
    }
}