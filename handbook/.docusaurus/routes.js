...
export default [
  ...
  },
  {
    ...
    component: ComponentCreator('/thingsgateway-docs/docs', '89d'),
    routes: [
      {
        path: '/thingsgateway-docs/docs/',
      ...
      {
        path: '/thingsgateway-docs/docs/pluginmc3e',
        component: ComponentCreator('/thingsgateway-docs/docs/pluginmc3e', 'f8d'),
        exact: true,
        sidebar: "docs"
      },
      {
